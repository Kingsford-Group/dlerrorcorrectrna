# network_model_integer_label_no_weight_epochs170.py
#
# Name: Laura Tung
#
# Usage: python network_model_integer_label_no_weight_epochs170.py
#
...
def train_model(model, train_left_kmers_input, train_right_kmers_input, train_read_features_input, train_consensus_features_input, train_rest_features_input, train_true_labels, epochs, batch_size, validation_split, verbose):
...
if __name__ == "__main__":
    ...
    model, history = train_model(model, train_left_kmers_input, train_right_kmers_input, train_read_features_input, train_consensus_features_input, train_rest_features_input, train_true_labels, epochs, batch_size, validation_split, verbose)
